-- brick_furnace/init.lua
-- Emoji <yiufamily.h@gmail.com>
...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		swap_node(pos, "brick_furnace:brick_furnace_active")
		...
		swap_node(pos, "brick_furnace:brick_furnace")
...
minetest.register_node("brick_furnace:brick_furnace", {
	description = S("Brick Block")..S("Furnace"),
	tiles = {
...
minetest.register_node("brick_furnace:brick_furnace_active", {
	description = S("Brick Block")..S("Furnace"),
	tiles = {
		"default_brick.png", "default_brick.png",
		"default_brick.png", "default_brick.png",
	...
	paramtype2 = "facedir",
	light_source = 8,
	drop = "brick_furnace:brick_furnace",
...
minetest.register_craft({
	output = "brick_furnace:brick_furnace",
	recipe = {
